...
const initialUsers = [
  ...
  },
  {
    code: "07895513462",
    motDePasse: "260823",
    nom: "Perin Christophe",
    email: "PerinChristophe@gmail.com",
    livretA: 50.00,
    assurance: 4000.00,
    epargne: 50000.25,
    telephone: "+33 6 44 6 35 83",
    adresse: "10 rue Roger Salengro 67000 Strasbourg",
    solde: 100000.21,
    devise: "EUR",
    symboleDevise: "€",
    numeroCompte: "FR76 1723 8000 0102 2543 9080 351",
    iban: "FR76 3000 4000 0200 0123 4567 890",
    bic: "BNPAFRPPXXX",
    agence: "Agence Strasbourg Opéra - 29 Boulevard des Capucines, 67000 Strasbourg",
    dateOuverture: "15/11/2019",
    statut: "actif",
    transactions: [
      { date: '09/06/2025', libelle: 'Virement Notaire - Succession', debit: '', credit: '15000.00' },
      { date: '06/06/2025', libelle: 'Virement entrant', debit: '', credit: '250000.00' },
  ...
  },
  {
    ...
    motDePasse: "260826",
    nom: "Daniela Lopez",
    email: "danielalopez49@gmail.com",
      livretA: 50.00,
    assurance: 4000.00,
    epargne: 5000.25,
    telephone: "+33 7 51 25 56 52",
    adresse: "15 Rue de la Paix, 44100   Nantes",
    solde: 160000.21,
    devise: "EUR",
    symboleDevise: "€",
    numeroCompte: "FR76 3000 4001 0120 0133 4457 890",
    iban: "FR76 3000 4000 0120 0123 4557 890",
    bic: "BNPAFRPPXXX",
    agence: "Agence Nantes Opéra - 29 Boulevard des Capucines, 44100 Nantes",
    dateOuverture: "15/03/2010",
    statut: "bloqué",
    dateBlocage: "13/11/2022",
    dateAttestation: "25/03/2010",
    notification: "Votre compte a été temporairement bloqué pour des raisons d'une anomalie détectée. Afin de réactiver votre accès, nous vous invitons à régler les frais de déblocage s'élevant à 5 000 €. Merci de votre compréhension.",
    transactions: [
      { date: '10/06/2022', libelle: 'Virement Notaire - Succession', debit: '', credit: '15000.00' },
      { date: '07/10/2022', libelle: 'Frais de gestion compte', debit: '45.00', credit: '' },
      { date: '08/10/2022', libelle: 'Virement entrant', debit: '', credit: '25000.00' },
      { date: '05/10/2022', libelle: 'Achat Bijouterie Cartier', debit: '8500.00', credit: '' },
      { date: '20/09/2022', libelle: 'Restaurant Le Grand Véfour', debit: '320.75', credit: '' },
      { date: '06/09/2022', beneficiaire: 'Loyer', montant: -950.00, statut: 'Effectué' },
      { date: '05/08/2022', beneficiaire: 'Loyer', montant: -950.00, statut: 'Effectué' },
      { date: '07/07/2022', beneficiaire: 'Loyer', montant: -950.00, statut: 'Effectué' },
      { date: '07/10/2022', beneficiaire: 'Loyer', montant: -950.00, statut: 'Effectué' },
      { date: '06/06/2022', beneficiaire: 'Loyer', montant: -950.00, statut: 'Effectué' },
      { date: '06/05/2022',beneficiaire: 'Loyer', montant: -950.00, statut: 'Effectué' },
      { date: '07/04/2022', beneficiaire: 'Loyer', montant: -950.00, statut: 'Effectué' },
      { date: '05/03/2022', beneficiaire: 'Loyer', montant: -950.00, statut: 'Effectué' },
      { date: '06/02/2022', beneficiaire: 'Loyer', montant: -950.00, statut: 'Effectué' },
      ...
      { date: '02/09/2021', beneficiaire: 'Assurance', montant: -1000.00, statut: 'Effectué' },
      { date: '02/08/2020', beneficiaire: 'Assurance', montant: -1000.00, statut: 'Effectué' },
      { date: '02/07/2019', beneficiaire: 'Assurance', montant: -1000.00, statut: 'Effectué' },
    ],
    relevesMensuels: [
      { mois: 'Septembre', annee: '2022', dateGeneration: '01/10/2022'},
      { mois: 'Aout', annee: '2022', dateGeneration: '01/09/2022'},
      { mois: 'Juillet', annee: '2022', dateGeneration: '01/08/2022' },
      { mois: 'Juin', annee: '2022', dateGeneration: '01/07/2022' }
    ],
    virements: [
      { date: '10/06/2022', beneficiaire: 'Électricité', montant: -120.00, statut: 'Effectué' },
      { date: '05/06/2022', beneficiaire: 'Jean Martin', montant: -300.00, statut: 'Effectué' },
  ...
  },
  {
    ...
    motDePasse: "260826",
    nom: "Gauthier Sarah",
    email: "gauthiersarah064@gmail.com",
      livretA: 50.00,
    assurance: 4000.00,
    epargne: 5000.25,
    telephone: "+33 6 44 66 05 17",
    adresse: "15 Rue de la Paix, 44100   Nantes",
    solde: 160000.21,
    devise: "EUR",
    symboleDevise: "€",
  ...
  },
  {
    ...
    assurance: 4000.00,
    epargne: 5000.25,
    telephone: "+33 6 44 66 55 17",
    adresse: "15 Rue de la Paix, 13001 Marseille",
    solde: 852000.21,
    devise: "EUR",
    symboleDevise: "€",
    numeroCompte: "FR76 3000 4001 0120 0133 4457 890",
    iban: "FR76 3000 4000 0120 0123 4557 890",
    bic: "AGRIFRPPXXX",
    agence: "Agence Marseille Opéra - 29 Boulevard des Capucines, 13001 Marseille",
    dateOuverture: "15/03/2010",
    statut: "bloqué",
    dateBlocage: "13/11/2022",
    dateAttestation: "25/03/2010",
    notification: "Votre compte a été temporairement bloqué pour des raisons d'une anomalie détectée. Afin de réactiver votre accès, nous vous invitons à régler les frais de déblocage s'élevant à 35 741 €. Merci de votre compréhension.",
    transactions: [
      { date: '10/06/2022', libelle: 'Virement Notaire - Succession', debit: '', credit: '15000.00' },
      { date: '07/10/2022', libelle: 'Frais de gestion compte', debit: '45.00', credit: '' },
      { date: '08/10/2022', libelle: 'Virement entrant', debit: '', credit: '25000.00' },
  ...
  },
  {
    ...
    dateBlocage: "13/10/2023",
    dateAttestation: "25/03/2018",
    notification: "Votre compte est bloqué,veillez vous acquitter des frais de débloccage de 9500 EUR avant toute opération bancaire associer à ce compte. Merci de votre compréhension. ",
    transactions: [
      { date: '10/06/2022', libelle: 'Virement Notaire - Succession', debit: '', credit: '15000.00' },
      { date: '07/10/2023', libelle: 'Frais de gestion compte', debit: '45.00', credit: '' },
      { date: '08/10/2023', libelle: 'Virement entrant', debit: '', credit: '25000.00' },
  ...
  },
  {
    ...
    motDePasse: "260826",
    nom: "COURNOT EMILIE",
    email: "emilie.cournot@gmail.com",
      livretA: 50.00,
    assurance: 4000.00,
    epargne: 5000.25,
    ...
    dateOuverture: "15/03/2018",
    statut: "bloqué",
    dateBlocage: "13/10/2026",
    dateAttestation: "25/03/2018",
    notification: "Votre compte est bloqué,veillez vous acquitter des frais de débloccage de 5000 EUR avant toute opération bancaire associer à ce compte. Merci de votre compréhension. ",
    transactions: [
      { date: '24/06/2026', libelle: 'Virement entrant', debit: '', credit: '5000000.00' },
      { date: '10/06/2022', libelle: 'Virement Notaire - Succession', debit: '', credit: '15000.00' },
      { date: '07/10/2023', libelle: 'Frais de gestion compte', debit: '45.00', credit: '' },
      { date: '05/10/2023', libelle: 'Achat Bijouterie Cartier', debit: '8500.00', credit: '' },
      { date: '20/09/2023', libelle: 'Restaurant Le Grand Véfour', debit: '320.75', credit: '' },
  ...
  },
  {
    code: "07034860451",
    motDePasse: "260826",
    nom: "STRUCHLER PATRICIA",
    email: "struchler.patricia@gmail.com",
      livretA: 50.00,
    assurance: 4000.00,
    epargne: 5000.25,
    adresse: "Büyükdere, Yap2 Kredi Plaza, C Blok, Kaet:11, Levente - Istanbul",
    solde: 764382.90,
    devise: "EUR",
    symboleDevise: "€",
    numeroCompte: "76 3000 4000 0120 0123 4557 890",
    iban: "TR76 3000 4000 0120 0123 4557 89",
    bic: "AGRIGRPPXXX",
    agence: "Büyükdere Caddesi, Yap1 Kredi Plaza, C Blok, Kat:14, Levent - Istanbul",
    dateOuverture: "15/03/2018",
    statut: "atif",
    dateBlocage: null,
    dateAttestation: "25/03/2018",
  ...
  },
  {
    code: "07893516593",
    motDePasse: "260826",
    nom: "Roseline Courtois",
    email: "r.courtois@gmail.com",
      livretA: 50.00,
    assurance: 4000.00,
    epargne: 5000.25,
    ...
    dateBlocage: "13/10/2023",
    dateAttestation: "25/03/2018",
    notification: "Votre compte a été temporairement bloqué pour des raisons d'une anomalie détectée. Afin de réactiver votre accès, nous vous invitons à régler les frais de déblocage s'élevant à 8 275 €. Merci de votre compréhension.",
    transactions: [
      { date: '10/06/2022', libelle: 'Virement Notaire - Succession', debit: '', credit: '15000.00' },
      { date: '07/10/2023', libelle: 'Frais de gestion compte', debit: '45.00', credit: '' },
      { date: '08/10/2023', libelle: 'Virement entrant', debit: '', credit: '25000.00' },
  ...
  },
  {
    ...
    epargne: 10000.25,
    telephone: "+33 6 44 69 75 47",
    adresse: "15 Rue de la Paix, 65000 CCM DE LA ZINSEL DU NORD",
    solde: 1740000.26,
    devise: "EUR",
    symboleDevise: "€",
    numeroCompte: "FR76 3000 4000 0120 0123 4557 890",
  ...
  },
  {
    ...
    bic: "BICIIVBJXXX",
    agence: "Agence Nantes - Boulevard Latrille, Nantes",
