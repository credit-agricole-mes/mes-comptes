      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-200 text-base leading-relaxed mb-6">
            Votre banque en ligne de confiance, offrant des<br />
            solutions bancaires modernes et efficaces.
          </p>
        ...
        {/* Contact section */}
        <div className="text-center mb-8">
          <h3 className="text-green-400 text-xl font-semibold mb-6">
            Contact
          </h3>
          ...
          <div className="mb-4 flex items-start justify-center gap-2">
            ...
            <p className="text-gray-200 text-sm leading-relaxed">
              Crédit Agricole - Banque, 1 Boulevard<br />
              Haussmann, 75009 Paris (France) - Adresse,<br />
              Horaire.
            </p>
          </div>
          ...
          <div className="mb-4 flex items-center justify-center gap-2">
            ...
            <a href="tel:157080200" className="text-white hover:text-green-400 transition text-xl font-bold">
              157 080 200
            </a>
          </div>
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <a href="mailto:warrants.info@creditagricole.com" className="text-gray-200 hover:text-green-400 transition text-sm break-all">
              warrants.info@creditagricole.com
            </a>
          </div>
        </div>
        ...
        <div className="text-center pt-8 border-t border-green-700">
          <p className="text-gray-300 text-sm">
            © 2024 Crédit Agricole | Tous droits réservés
          </p>
        </div>
